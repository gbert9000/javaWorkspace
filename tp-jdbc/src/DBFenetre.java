...
public class DBFenetre extends JFrame {
...
/**
  ...
  * Le bouton
  */
  private JButton load = new JButton(new ImageIcon("img/play.png"));
  ...
  */
  private String requete = "SELECT  * FROM utilisateur";
